            ...
            <div className='credits-container ohp center'>
                ...
                <div className='credits-wrapper ohpw center'>
                    ...
                    <div className='credit_multiple-wrapper center'>    
                        ...
                        <div className='credit_name center'>
                            IRIS MECHELLE L. GARGAR 
                        </div>
                        <div className='credit_name center'>
                            MICHAEL ARIEL CABUGAO
                        </div>
                        <div className='credit_name center'>
                            FREDERICK RUNAS
                        </div>
                        <div className='credit_name center'>
                            ALLONDRA PAULINE FARRO
                        </div>
                    </div>
                    ...
                    <div className='credit_multiple-wrapper center'>    
                        ...
                        <div className='credit_name center'>
                            KRISTINA MARI BALTAZAR
                        </div>
                        <div className='credit_name center'>
                            CIELO ANNE CALZADO-MENESES
                        </div>
                        <div className='credit_name center'>
                            CHERRY CAMACHO
                        </div>
